...
<%
    ...
    if(newpassword.equals(confirmpassword))
    {
        ...
        String userid=session.getAttribute("jobseekerid").toString();
        String query="update recruitizapp_login set password='"+newpassword+"' where userid='"+userid+"' and password='"+oldpassword+"'";
